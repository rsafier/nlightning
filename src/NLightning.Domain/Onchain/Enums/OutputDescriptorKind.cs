...
/// <summary>
/// What an output of a commitment on chain is to us, and so how it is resolved (BOLT 5 plan §3.3). Persisted as a byte
/// later (output resolution rows); never renumber.
/// </summary>
public enum OutputDescriptorKind : byte
{
    ...
    /// <summary>Our <c>to_local</c> on our commitment: sweep after <c>to_self_delay</c> with
    /// <c>&lt;local_delayedsig&gt; &lt;&gt;</c> (B5-LCL-01).</summary>
    DelayedToLocal = 1,
