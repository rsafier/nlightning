...
/// </summary>
/// <remarks>Needs no private key (<c>secret * G == point</c>). Implemented in Application by
/// <c>EngineRevocationVerifierPort</c> over <c>IPerCommitmentSecretVerifier</c> (Infrastructure.Bitcoin, plan N3-T3).
/// The shachain insert (B2-RAA-R02/R04) is done by the caller after the engine accepts the RAA.</remarks>
