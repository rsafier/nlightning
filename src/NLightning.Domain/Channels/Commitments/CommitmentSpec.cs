...
/// </para>
/// </remarks>
public sealed class CommitmentSpec
{
    ...
    public CommitmentSpec(ulong toLocalMsat, ulong toRemoteMsat, ulong feeRatePerKw, IEnumerable<Htlc>? htlcs = null)
    {
    ...
    /// below zero.
    /// </summary>
    public static CommitmentSpec FromChannel(ChannelModel channel)
    {
        ...
        return new CommitmentSpec(toLocalMsat, toRemoteMsat, (ulong)channel.ChannelConfig.FeeRateAmountPerKw.Satoshi,
                                  htlcs);
    }
}