...
internal sealed class SphinxService : ISphinxService
{
    ...
    {
        return _builder.Build(hops, sessionKey, associatedData, hopPayloadsLength);
    }
                                       ...
                                       CompactPubKey? pathKey = null)
    {
        ...
        return Peel(packet, associatedData, _secureKeyManager.GetNodeKeyPair().PrivKey, pathKey);
    }
    ...
    public PeeledOnion Peel(OnionPacket packet, ReadOnlySpan<byte> associatedData, PrivKey nodeKey,
                            CompactPubKey? pathKey = null)
    {
        return _peeler.Peel(packet, associatedData, nodeKey, pathKey);
    }
}