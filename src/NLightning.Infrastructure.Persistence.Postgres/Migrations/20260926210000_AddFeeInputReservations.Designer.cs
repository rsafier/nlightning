...
namespace NLightning.Infrastructure.Persistence.Postgres.Migrations
{
    ...
    [Migration("20260926210000_AddFeeInputReservations")]
            ...
            modelBuilder.Entity("NLightning.Infrastructure.Persistence.Entities.Bitcoin.FeeInputReservationEntity", b =>
                {
                    ...
                    b.Property<long>("ChangeAmountSats")
                        .HasColumnType("bigint")
                        .HasColumnName("change_amount_sats");

                    b.Property<byte[]>("ChangeScript")
                        .HasMaxLength(64)
                        .HasColumnType("bytea")
                        .HasColumnName("change_script");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_fee_input_reservations");

                    b.ToTable("fee_input_reservations", (string)null);
                });
            ...
            modelBuilder.Entity("NLightning.Infrastructure.Persistence.Entities.Bitcoin.FeeInputReservationInputEntity", b =>
                {
                    ...
                    b.Property<byte[]>("ScriptPubKey")
                        ...
                        .HasMaxLength(64)
                        .HasColumnType("bytea")
                        .HasColumnName("script_pub_key");

                    b.HasKey("TransactionId", "Index")
                        .HasName("pk_fee_input_reservation_inputs");

                    b.HasIndex("ReservationId")
                        .HasDatabaseName("ix_fee_input_reservation_inputs_reservation_id");
            ...
            modelBuilder.Entity("NLightning.Infrastructure.Persistence.Entities.Bitcoin.FeeInputReservationInputEntity", b =>
                {
                    b.HasOne("NLightning.Infrastructure.Persistence.Entities.Bitcoin.FeeInputReservationEntity", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_fee_input_reservation_inputs_fee_input_reservations_reserva");
                });
