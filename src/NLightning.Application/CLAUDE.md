...
- Existing coverage: OpenChannel1, FundingCreated, FundingConfirmed, ChannelReady, AcceptChannel1, ChannelManager (block events) and PeerManager. Nothing covers FundingSigned or MessageFactory.
