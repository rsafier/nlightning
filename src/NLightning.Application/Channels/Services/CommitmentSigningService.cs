...
public sealed class CommitmentSigningService : ICommitmentSigner, ICommitmentVerifier
{
    ...
    /// <inheritdoc />
    public CommitmentSignatures SignRemoteCommitment(ChannelModel channel, CommitmentSpec spec,
                                                     ...
                                                     CompactPubKey remotePerCommitmentPoint)
    {
        ...
        return new CommitmentSignatures(built.Transaction.TxId, signature, htlcSignatures);
    }

    /// <inheritdoc />
    public CommitmentSignatures VerifyLocalCommitment(ChannelModel channel, CommitmentSpec spec,
                                                      ...
                                                      IReadOnlyList<CompactSignature> htlcSignatures)
    {
        ...
        return new CommitmentSignatures(built.Transaction.TxId, signature, htlcSignatures.ToList());
    }
