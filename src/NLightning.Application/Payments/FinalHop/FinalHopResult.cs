...
public sealed record FinalHopResult
{
    ...
    /// <summary>
    /// True when the invoice is already <c>Settled</c> and this HTLC, a committed part of the set that settled it (its
    /// record carries the preimage, NL-323), is fulfilled without touching it (BOLT 4 requires the whole set to be
    /// fulfilled).
    /// </summary>
