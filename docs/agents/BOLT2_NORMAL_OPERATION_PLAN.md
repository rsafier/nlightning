...
- **Status (2026-09-26, `wip/fafo` @ `4c37998`, after ABCD wave 7):** no milestone changed; wave 7 closed the M3b rows of §6.4 (B2-DEL-W01, B2-DEL-06, B2-DEL-R03 done; B2-DEL-07 partial, NL-339): update_fail_htlc/update_fulfill_htlc carry TLV 1 and 3 through the handlers, persistence (migration `AddAttributionData`), retransmission and `MessageFactory` (NL-022, NL-325, NL-326 fixed). An oversized fulfillment_payload fails the channel after a valid preimage is committed. `HtlcExpiryMonitor` still decides PreimageKnown for final-hop HTLCs from the invoice status (NL-337, N9 follow-up).
