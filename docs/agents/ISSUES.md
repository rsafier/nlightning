...
| fixed | 14 | 47 | 112 | 76 | 249 |
| wontfix | 0 | 0 | 2 | 4 | 6 |
| duplicate | 0 | 0 | 1 | 0 | 1 |
| **Total** | **14** | **53** | **136** | **175** | **378** |
...
- **Status:** open (partial: 97cdc27, ff09f96)
- **Severity:** medium
- **Kind:** tech-debt
