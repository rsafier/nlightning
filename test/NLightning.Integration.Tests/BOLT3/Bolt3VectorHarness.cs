...
internal sealed class Bolt3VectorHarness
{
    ...
    /// </summary>
    public CommitmentTxSpec Spec =>
        AsNodeB
            ? new CommitmentTxSpec(Vector.ToRemoteMsat, Vector.ToLocalMsat, Vector.FeeRatePerKw,
                                 Vector.HtlcIds.Select(GetMirroredHtlc))
            : new CommitmentTxSpec(Vector.ToLocalMsat, Vector.ToRemoteMsat, Vector.FeeRatePerKw,
