...
/// <summary>
/// A clock (wall time and timestamps) that moves only when <see cref="Advance"/> is called; its one-shot timers fire
/// synchronously, on the caller's thread, once the clock reaches their due time.
/// </summary>
